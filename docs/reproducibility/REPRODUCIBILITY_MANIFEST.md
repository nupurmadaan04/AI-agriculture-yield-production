# Platform Scientific Reproducibility Manifest
...
```bash
# 1. Execute Day 36 dedicated scientific reproducibility test suite
pytest tests/test_day36_reproducibility.py -v

# 2. Execute Day 34 & Day 35 operational and UI contract suites
pytest tests/test_day35_ui_contracts.py tests/test_deployment_verification.py -v

# 3. Execute full acceptance and resilience suite
